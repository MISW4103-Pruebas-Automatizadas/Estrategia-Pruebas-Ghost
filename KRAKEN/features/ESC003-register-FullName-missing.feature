...
@user1 @web
Scenario: Quiero crear el blog y el usuario autorizado(falta nombre)
  ...
  Then I should see "Please enter a name." in view with selector "#setup > div.form-group.error > p"
